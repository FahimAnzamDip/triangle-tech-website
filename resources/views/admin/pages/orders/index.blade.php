        ...
        <div class="section-body">
            <div class="row mb-4">
                <div class="col-md-12 d-flex justify-content-end">
                    ...
                    <a href="{{ route('orders.canceled') }}" class="btn btn-warning mr-3"><div class="badge badge-white">{{ \App\Models\Order::where('status', 'Canceled')->count() }}</div> Canceled</a>

                    <a href="{{ route('orders.failed') }}" class="btn btn-danger mr-3"><div class="badge badge-white">{{ \App\Models\Order::where('status', 'Failed')->count() }}</div> Failed</a>

                    <a href="{{ route('orders.completed') }}" class="btn btn-success"><div class="badge badge-white">{{ \App\Models\Order::where('status', 'Complete')->count() }}</div> Completed</a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
